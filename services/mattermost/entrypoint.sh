...
sed -i 's#api.segment.io#abc.example.com#gI' /mattermost/bin/mattermost
sed -i 's#pdat.matterlytics.com#abcd.abcdefghijlk.com#gI' /mattermost/bin/mattermost
sed -i 's#api.rudderlabs.com#abc.abcdefghij.com#gI' /mattermost/bin/mattermost
sed -i 's#securityupdatecheck.mattermost.com#xxxxxxxxxxxxxxxxxxxxxx.example.com#gI' /mattermost/bin/mattermost
